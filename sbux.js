...
var _user$project$Soundex$paddOrTrimToThreeDigits = function (a) {
	return A2(
		_elm_lang$core$String$left,
		4,
		A2(_elm_lang$core$Basics_ops['++'], a, '000'));
};
var _user$project$Soundex$setFirstCharacter = function (_p0) {
	var _p1 = _p0;
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_p1._0,
		A2(_elm_lang$core$String$dropLeft, 1, _p1._1));
};
var _user$project$Soundex$removeVowelsAfterFirst = _elm_lang$core$Tuple$mapSecond(
	A3(
		_elm_lang$core$Regex$replace,
		_elm_lang$core$Regex$All,
		_elm_lang$core$Regex$regex('[aeiouy]'),
		function (match) {
			return _elm_lang$core$Native_Utils.eq(match.index, 0) ? match.match : '';
		}));
var _user$project$Soundex$removeAdjacentDigits = function () {
	var rdcr = F2(
		function (current, _p2) {
			var _p3 = _p2;
			var _p5 = _p3._0;
			var _p4 = _p3._1;
			return (!_elm_lang$core$Native_Utils.eq(_p5, current)) ? {
				ctor: '_Tuple2',
				_0: current,
				_1: {ctor: '::', _0: current, _1: _p4}
			...
			return _elm_lang$core$String$fromList(
				_elm_lang$core$Tuple$second(
					A3(
						...
						_elm_lang$core$String$toList(body))));
		});
}();
var _user$project$Soundex$consonantToDigit = function (a) {
	return A2(
		_elm_lang$core$List$member,
		a,
		{
		...
		}) ? _elm_lang$core$Native_Utils.chr('1') : (A2(
		_elm_lang$core$List$member,
		a,
		{
			ctor: '::',
		...
		}) ? _elm_lang$core$Native_Utils.chr('2') : (A2(
		_elm_lang$core$List$member,
		a,
		{
			ctor: '::',
		...
		}) ? _elm_lang$core$Native_Utils.chr('3') : (_elm_lang$core$Native_Utils.eq(
		_elm_lang$core$Native_Utils.chr('l'),
		a) ? _elm_lang$core$Native_Utils.chr('4') : (A2(
		_elm_lang$core$List$member,
		a,
		{
			ctor: '::',
		...
		}) ? _elm_lang$core$Native_Utils.chr('5') : (_elm_lang$core$Native_Utils.eq(
		_elm_lang$core$Native_Utils.chr('r'),
		a) ? _elm_lang$core$Native_Utils.chr('6') : a)))));
};
var _user$project$Soundex$consonantsToDigits = _elm_lang$core$Tuple$mapSecond(
	function (body) {
		return _elm_lang$core$String$fromList(
			A2(
				_elm_lang$core$List$map,
				_user$project$Soundex$consonantToDigit,
				_elm_lang$core$String$toList(body)));
	});
var _user$project$Soundex$removeHandW = _elm_lang$core$Tuple$mapSecond(
	A3(
		_elm_lang$core$Regex$replace,
		_elm_lang$core$Regex$All,
		_elm_lang$core$Regex$regex('[hw]'),
		function (_p6) {
			return '';
		}));
var _user$project$Soundex$soundex = function (word) {
	return _user$project$Soundex$paddOrTrimToThreeDigits(
		_user$project$Soundex$setFirstCharacter(
			_user$project$Soundex$removeVowelsAfterFirst(
				_user$project$Soundex$removeAdjacentDigits(
					_user$project$Soundex$consonantsToDigits(
						_user$project$Soundex$removeHandW(
							{
								ctor: '_Tuple2',
								_0: _elm_lang$core$String$toUpper(
									A2(_elm_lang$core$String$left, 1, word)),
								_1: _elm_lang$core$String$toLower(word)
							}))))));
};

var _user$project$Style$Wrapper = {ctor: 'Wrapper'};
var _user$project$Style$OrderName = {ctor: 'OrderName'};
var _user$project$Style$Cup = {ctor: 'Cup'};
var _user$project$Style$css = function (_p0) {
	return _rtfeldman$elm_css$Css$stylesheet(
		A2(_rtfeldman$elm_css$Css_Namespace$namespace, 'sbux', _p0));
}(
	{
		ctor: '::',
		_0: A2(
			_rtfeldman$elm_css$Css$class,
			_user$project$Style$Cup,
			{
				ctor: '::',
				_0: _rtfeldman$elm_css$Css$width(
					_rtfeldman$elm_css$Css$px(615)),
				_1: {
					ctor: '::',
					_0: _rtfeldman$elm_css$Css$height(
						_rtfeldman$elm_css$Css$px(369)),
					_1: {
						ctor: '::',
						_0: A2(
									...
									_1: {
										...
										_1: {
											...
											_0: _rtfeldman$elm_css$Css$backgroundImage(
												_rtfeldman$elm_css$Css$url('http://i2.mirror.co.uk/incoming/article6758362.ece/ALTERNATES/s615b/Starbucks-Cup.jpg')),
											_1: {ctor: '[]'}
										}
									}
								}
		...
		_1: {
			...
			_0: A2(
				_rtfeldman$elm_css$Css$class,
				_user$project$Style$OrderName,
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Css$width(
						_rtfeldman$elm_css$Css$px(610)),
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$height(
...
var _user$project$Starbucks$soundIndexLabel = function (model) {
	var _p0 = model.matchData;
	if (_p0.ctor === 'Nothing') {
		return A2(
					...
					A2(
						...
						A2(
							...
							_elm_lang$core$Basics$toString(
								_elm_lang$core$Dict$size(_p0._0)),
							' sound indexs'))),
				_1: {ctor: '[]'}
			});
	}
};
var _user$project$Starbucks$nameIndexLabel = function (model) {
	var _p1 = model.nameMatches;
	if (_p1.ctor === 'Nothing') {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
				...
				_0: _elm_lang$html$Html$text(
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(
								_elm_lang$core$Dict$size(_p1._0)),
							' name sounds'))),
				_1: {ctor: '[]'}
			});
	}
};
var _user$project$Starbucks$missesLabel = function (model) {
	var _p2 = model.nameMisses;
	if (_p2.ctor === 'Nothing') {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
				...
				_0: _elm_lang$html$Html$text(
					A2(
						...
						A2(
							...
							' names without matching words'))),
				_1: {ctor: '[]'}
			});
	}
};
var _user$project$Starbucks$uniqueNames = function (model) {
	var _p3 = model.nameMisses;
	if (_p3.ctor === 'Nothing') {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
...
var _user$project$Starbucks$styleOutput = _rtfeldman$elm_css$Css$compile(
	{
		ctor: '::',
		_0: _user$project$Style$css,
		_1: {ctor: '[]'}
	});
var _user$project$Starbucks$_p6 = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('sbux');
var _user$project$Starbucks$id = _user$project$Starbucks$_p6.id;
var _user$project$Starbucks$class = _user$project$Starbucks$_p6.$class;
var _user$project$Starbucks$classList = _user$project$Starbucks$_p6.classList;
var _user$project$Starbucks$howMutch = F2(
	function (match, soundex) {
		return _elm_lang$core$List$length(
			A2(
				_elm_lang$core$Maybe$withDefault,
				{ctor: '[]'},
				A2(_elm_lang$core$Dict$get, soundex, match)));
	});
var _user$project$Starbucks$transform = _user$project$Soundex$soundex;
var _user$project$Starbucks$lookup = F3(
	function (match, sndx, index) {
		var _p7 = match;
		if (_p7.ctor === 'Just') {
			return A2(
				_elm_lang$core$Maybe$withDefault,
				...
				A2(
					...
					function (ls) {
						return _elm_lang$core$List$head(
							A2(_elm_lang$core$List$drop, index - 1, ls));
					},
					A2(_elm_lang$core$Dict$get, sndx, _p7._0)));
		} else {
			return sndx;
		}
	});
var _user$project$Starbucks$nameMisses = function (model) {
	var _p8 = {ctor: '_Tuple2', _0: model.matchData, _1: model.nameMatches};
	if (((_p8.ctor === '_Tuple2') && (_p8._0.ctor === 'Just')) && (_p8._1.ctor === 'Just')) {
		var flattenMatch = function (_p9) {
			var _p10 = _p9;
			return A2(
				_elm_lang$core$List$map,
				function (n) {
					return {ctor: '_Tuple2', _0: _p10._0, _1: n};
				},
				_p10._1);
		};
		var diffs = _elm_lang$core$Dict$toList(
			A2(_elm_lang$core$Dict$diff, _p8._1._0, _p8._0._0));
		return _elm_lang$core$Maybe$Just(
			A2(_elm_lang$core$List$concatMap, flattenMatch, diffs));
	} else {
		return _elm_lang$core$Maybe$Nothing;
	}
};
var _user$project$Starbucks$updateMisses = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			nameMisses: _user$project$Starbucks$nameMisses(model)
		});
};
var _user$project$Starbucks$buildMatchData = function (words) {
	var addWord = F2(
		function (_p11, data) {
			var _p12 = _p11;
			return A3(
		...
		A2(
			...
			function (word) {
				return {
					ctor: '_Tuple2',
					_0: word,
					_1: _user$project$Starbucks$transform(word)
				};
			},
			words));
};
var _user$project$Starbucks$initModel = {name: '', sndx: '', sbuxName: '', isBusy: true, matchData: _elm_lang$core$Maybe$Nothing, soundexCount: '', nameCount: '', nameMatches: _elm_lang$core$Maybe$Nothing, nameMisses: _elm_lang$core$Maybe$Nothing};
var _user$project$Starbucks$init = {ctor: '_Tuple2', _0: _user$project$Starbucks$initModel, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$Starbucks$setWords = _elm_lang$core$Native_Platform.incomingPort(
	'setWords',
	_elm_lang$core$Json_Decode$array(_elm_lang$core$Json_Decode$string));
var _user$project$Starbucks$setNames = _elm_lang$core$Native_Platform.incomingPort(
	'setNames',
	_elm_lang$core$Json_Decode$array(_elm_lang$core$Json_Decode$string));
var _user$project$Starbucks$Model = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {name: a, sndx: b, sbuxName: c, isBusy: d, matchData: e, soundexCount: f, nameCount: g, nameMatches: h, nameMisses: i};
	});
var _user$project$Starbucks$CompiledNames = function (a) {
	return {ctor: 'CompiledNames', _0: a};
};
var _user$project$Starbucks$CompiledLookup = function (a) {
	return {ctor: 'CompiledLookup', _0: a};
};
var _user$project$Starbucks$NewNames = function (a) {
	return {ctor: 'NewNames', _0: a};
};
var _user$project$Starbucks$NewWords = function (a) {
	return {ctor: 'NewWords', _0: a};
};
var _user$project$Starbucks$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Starbucks$setWords(_user$project$Starbucks$NewWords),
			_1: {
				ctor: '::',
				_0: _user$project$Starbucks$setNames(_user$project$Starbucks$NewNames),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Starbucks$GotRandom = function (a) {
	return {ctor: 'GotRandom', _0: a};
};
var _user$project$Starbucks$update = F2(
	function (msg, model) {
		var _p13 = msg;
		switch (_p13.ctor) {
			case 'CompiledLookup':
				...
				return {
					ctor: '_Tuple2',
					_0: _user$project$Starbucks$updateMisses(
						_elm_lang$core$Native_Utils.update(
							model,
							{
								isBusy: false,
								matchData: _elm_lang$core$Maybe$Just(_p14),
								soundexCount: _elm_lang$core$Basics$toString(
				...
				return {
					...
					_0: _user$project$Starbucks$updateMisses(
						_elm_lang$core$Native_Utils.update(
							model,
							{
								nameMatches: _elm_lang$core$Maybe$Just(_p15),
								nameCount: _elm_lang$core$Basics$toString(
									_elm_lang$core$Dict$size(_p15))
							})),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'NewWords':
				return {
					...
					_1: A2(
						_elm_lang$core$Task$perform,
						function (ws) {
							return _user$project$Starbucks$CompiledLookup(
								_user$project$Starbucks$buildMatchData(ws));
						},
						_elm_lang$core$Task$succeed(_p13._0))
				};
			case 'NewNames':
				return {
					ctor: '_Tuple2',
					...
					_1: A2(
						_elm_lang$core$Task$perform,
						function (ws) {
							return _user$project$Starbucks$CompiledNames(
								_user$project$Starbucks$buildMatchData(ws));
						},
						_elm_lang$core$Task$succeed(_p13._0))
				};
			case 'NameChange':
				if (_p13._0 === '') {
					...
					var _p16 = _p13._0;
					var soundex = _user$project$Starbucks$transform(_p16);
					var optionCount = A2(
						_elm_lang$core$Maybe$withDefault,
						0,
						A2(
							_elm_lang$core$Maybe$map,
							function (matchData) {
								return A2(_user$project$Starbucks$howMutch, matchData, soundex);
							},
							model.matchData));
					return _elm_lang$core$Native_Utils.eq(optionCount, 0) ? {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{name: _p16, sndx: soundex, sbuxName: soundex}),
						_1: _elm_lang$core$Platform_Cmd$none
					} : {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								name: _p16,
								sndx: _user$project$Starbucks$transform(_p16)
							}),
						_1: A2(
							_elm_lang$core$Random$generate,
							_user$project$Starbucks$GotRandom,
							A2(_elm_lang$core$Random$int, 0, optionCount - 1))
					};
				}
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							sbuxName: A3(_user$project$Starbucks$lookup, model.matchData, model.sndx, _p13._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$Starbucks$NameChange = function (a) {
	return {ctor: 'NameChange', _0: a};
};
var _user$project$Starbucks$cup = function (model) {
	var _p17 = {ctor: '_Tuple2', _0: model.matchData, _1: model.nameMatches};
	if (_p17._0.ctor === 'Nothing') {
		if (_p17._1.ctor === 'Nothing') {
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Please wait, we are building our corpus'),
					_1: {ctor: '[]'}
				});
		} else {
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Please wait, we are building our corbus'),
					_1: {ctor: '[]'}
				});
		}
	} else {
		return A2(
			...
			{
				ctor: '::',
				_0: _user$project$Starbucks$class(
					{
						ctor: '::',
						_0: _user$project$Style$Wrapper,
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
			{
				...
				_0: A2(
					_elm_lang$html$Html$input,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(_user$project$Starbucks$NameChange),
							_1: {
								ctor: '::',
								_0: _user$project$Starbucks$class(
									{
										ctor: '::',
										_0: _user$project$Style$OrderName,
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(model.sbuxName),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{ctor: '[]'},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									A2(_elm_lang$core$Basics_ops['++'], 'Your sound index: ', model.sndx)),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: _user$project$Starbucks$soundIndexLabel(model),
							_1: {
								ctor: '::',
								_0: _user$project$Starbucks$nameIndexLabel(model),
								_1: {
									ctor: '::',
									_0: _user$project$Starbucks$missesLabel(model),
									_1: {
										ctor: '::',
										_0: _user$project$Starbucks$uniqueNames(model),
										_1: {ctor: '[]'}
									}
								}
							}
...
var _user$project$Starbucks$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A3(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(_user$project$Starbucks$styleOutput.css),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _user$project$Starbucks$cup(model),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Starbucks$main = _elm_lang$html$Html$program(
	{init: _user$project$Starbucks$init, view: _user$project$Starbucks$view, update: _user$project$Starbucks$update, subscriptions: _user$project$Starbucks$subscriptions})();

var Elm = {};
Elm['Starbucks'] = Elm['Starbucks'] || {};
if (typeof _user$project$Starbucks$main !== 'undefined') {
    _user$project$Starbucks$main(Elm['Starbucks'], 'Starbucks', undefined);
}
